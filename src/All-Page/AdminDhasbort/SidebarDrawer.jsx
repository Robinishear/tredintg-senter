      ...
      >
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              <ul id="dropdown-example" className="hidden py-2 space-y-2">
                <li>
                  <a
                    href="#"
                    className="flex items-center w-full p-2 pl-11 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >
                    Products
                  </a>
                </li>
            ...
            {/* Add rest of menus here (Inbox, Users, Products, Sign In, Sign Up) */}
          </ul>
        </div>
      </div>
    </div>
