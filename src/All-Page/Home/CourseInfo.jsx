...
const CourseInfo = () => {
  return (
    <div className="p-6 min-h-screen mt-4 ">
      <div className="max-w-7xl mx-auto border  rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center md:items-start gap-6">
        {/* Left Side Text */}
        <div className="flex-1">
          <h3 className="text-blue-600 font-semibold text-sm mb-1">
            আমাদের সম্পর্কে
          </h3>
          <h2 className="text-gray-900 font-extrabold text-2xl leading-tight mb-3">
          ...
          <p className="text-gray-700 text-sm mb-6 leading-relaxed">
            ...
            হিসেবে গড়ে তোলা। আমরা চাই বাংলাদেশের আইটি খাতে একটি শক্তিশালী
          ...
          <p className="text-gray-700 text-sm mb-6 leading-relaxed">
            আগামী প্রজন্মকে আধুনিক প্রযুক্তি শিক্ষায় বিশ্বমানের সুযোগ প্রদানের
            মাধ্যমে একটি প্রযুক্তি-নির্ভর সমৃদ্ধ বাংলাদেশ গড়ে তোলা।
          </p>

          <h3 className="text-blue-600 font-semibold text-sm mb-2">
            আমাদের বৈশিষ্ট্য
          </h3>
          <ul className="list-disc list-inside text-gray-700 text-sm mb-6 leading-relaxed space-y-1">
          ...
          <button
            type="button"
            className="bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded hover:bg-blue-700 transition"
          >
            Branch Registration
          </button>
        </div>
